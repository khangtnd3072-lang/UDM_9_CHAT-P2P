"""
P2P Peer Module - Direct Peer-to-Peer Communication
=====================================================
Mỗi Peer vừa là Server (listening for incoming connections)
vừa là Client (kết nối đến Peer khác).

Architecture:
    Peer A ◄──────────────────────────► Peer B
         (Direct TCP, E2EE Handshake)
         
Không cần Server relay - Decentralized!
"""
...
class P2PPeer:
    ...
    Attributes:
        ...
        listen_port: Port để listening (vd: 5001)
        peers: Dict[peer_name] -> (socket, crypto, metadata)
    ...
    def __init__(self, peer_name: str, listen_host: str = "127.0.0.1", listen_port: int = 5000, secure: bool = True):
        ...
        # Track active threads để cleanup
    ...
    def _listen_for_peers(self):
        ...
        self.server_socket.settimeout(1.0)  # ✓ Set timeout để có thể check server_running
        ...
        try:
            while self.server_running:
                try:
                    ...
                    if self.server_running:  # ✓ Chỉ log error nếu server còn chạy
    ...
    def shutdown(self):
        ...
        # ✓ Chờ tất cả threads thoát (với timeout)
